...
export async function sendEmail(params) {
  ...
  try {
    // In real implementation, we'd send real emails
    // For now just log the attempt without actually sending
    console.log({
      to: params.to,
      from: SENDER_EMAIL,
...
function getOrderStatusEmailContent(orderId, status, trackingCode) {
