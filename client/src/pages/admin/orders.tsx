  ...
  const orderColumns = [
    ...
    },
    {
      ...
      cell: ({ row }: any) => {
        ...
        return (
          <span
            className={`px-2 py-1 rounded-full text-xs font-medium ${orderStatusColors[status] || "bg-gray-100"}`}
          >
            {status}
          </span>
        );
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-4">
                      ...
                      <div>
                        ...
                        <p>
                          ...
                          <span
                            className={`ml-2 px-2 py-1 rounded-full text-xs font-medium ${orderStatusColors[selectedOrder.status] || "bg-gray-100"}`}
                          >
                    ...
                    <div className="space-y-4">
                        ...
                        <div>
                          ...
                          <div className="flex space-x-2">
                            ...
                            <Button
                              variant="secondary"
                              disabled={
                                updateOrderMutation.isPending || !trackingCode
                              }
                              onClick={() => {
                      ...
                      {selectedOrder.deliveryTrackingCode && (
                        <div className="bg-blue-50 p-3 rounded-md">
                          <h3 className="font-medium mb-1 text-blue-800">
                            {t("admin.orders.trackingInfo")}
                          </h3>
            ...
            <div>
              <Dialog>
                ...
                <DialogContent>
                  <DialogHeader>
                    <DialogTitle>
                      {t("admin.orders.clearOrdersConfirmTitle")}
                    </DialogTitle>
                    <DialogDescription>
