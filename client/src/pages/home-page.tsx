  ...
  return (
    <div>
      ...
      <section className="py-16 bg-gray-100">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold mb-2 text-center">{t("subscriptions.title")}</h2>
          <p className="text-gray-500 text-center mb-12">{t("subscriptions.subtitle")}</p>
          
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {/* Basic Plan */}
            <div className="bg-white rounded-lg shadow-md overflow-hidden">
              <div className="bg-gray-50 p-6 text-center border-b">
                <h3 className="text-xl font-bold mb-2">{t("subscriptions.basic.title")}</h3>
                <div className="text-4xl font-bold mb-1">$9.99<span className="text-base font-normal text-gray-500">/month</span></div>
                <p className="text-gray-500">{t("subscriptions.basic.description")}</p>
              </div>
              <div className="p-6">
                <ul className="space-y-3 mb-8">
                  <li className="flex items-center">
                    <CheckIcon className="mr-3 text-green-500" />
                    <span>{t("subscriptions.basic.benefits.discount")}</span>
                  </li>
                  <li className="flex items-center">
                    <CheckIcon className="mr-3 text-green-500" />
                    <span>{t("subscriptions.basic.benefits.earlyAccess")}</span>
                  </li>
                  <li className="flex items-center">
                    <CheckIcon className="mr-3 text-green-500" />
                    <span>{t("subscriptions.basic.benefits.newsletter")}</span>
                  </li>
                  <li className="flex items-center opacity-50">
                    <XIcon className="mr-3 text-red-500" />
                    <span>{t("subscriptions.basic.nonBenefits.collections")}</span>
                  </li>
                  <li className="flex items-center opacity-50">
                    <XIcon className="mr-3 text-red-500" />
                    <span>{t("subscriptions.basic.nonBenefits.shipping")}</span>
                  </li>
                </ul>
                <Button variant="outline" className="w-full" onClick={() => window.location.href = "/auth"}>
                  {t("subscriptions.subscribeButton")}
                </Button>
              </div>
            </div>
            
            {/* Premium Plan (Highlighted) */}
            <div className="bg-white rounded-lg shadow-md overflow-hidden transform md:scale-105 border-2 border-primary">
              <div className="bg-primary p-6 text-center border-b">
                <span className="inline-block bg-white text-primary text-xs uppercase font-bold tracking-wider px-2 py-1 rounded-full mb-2">{t("subscriptions.premium.popular")}</span>
                <h3 className="text-xl font-bold mb-2 text-white">{t("subscriptions.premium.title")}</h3>
                <div className="text-4xl font-bold text-white mb-1">$19.99<span className="text-base font-normal opacity-75">/month</span></div>
                <p className="text-white opacity-90">{t("subscriptions.premium.description")}</p>
              </div>
              <div className="p-6">
                <ul className="space-y-3 mb-8">
                  <li className="flex items-center">
                    <CheckIcon className="mr-3 text-green-500" />
                    <span>{t("subscriptions.premium.benefits.discount")}</span>
                  </li>
                  <li className="flex items-center">
                    <CheckIcon className="mr-3 text-green-500" />
                    <span>{t("subscriptions.premium.benefits.earlyAccess")}</span>
                  </li>
                  <li className="flex items-center">
                    <CheckIcon className="mr-3 text-green-500" />
                    <span>{t("subscriptions.premium.benefits.newsletter")}</span>
                  </li>
                  <li className="flex items-center">
                    <CheckIcon className="mr-3 text-green-500" />
                    <span>{t("subscriptions.premium.benefits.collections")}</span>
                  </li>
                  <li className="flex items-center">
                    <CheckIcon className="mr-3 text-green-500" />
                    <span>{t("subscriptions.premium.benefits.shipping")}</span>
                  </li>
                </ul>
                <Button className="w-full bg-primary hover:bg-blue-600" onClick={() => window.location.href = "/auth"}>
                  {t("subscriptions.subscribeButton")}
                </Button>
              </div>
            </div>
            ...
            <div className="bg-white rounded-lg shadow-md overflow-hidden">
              <div className="bg-gray-800 p-6 text-center border-b">
                <h3 className="text-xl font-bold mb-2 text-white">{t("subscriptions.vip.title")}</h3>
                <div className="text-4xl font-bold text-white mb-1">$39.99<span className="text-base font-normal opacity-75">/month</span></div>
                <p className="text-white opacity-90">{t("subscriptions.vip.description")}</p>
              </div>
              <div className="p-6">
                <ul className="space-y-3 mb-8">
                  <li className="flex items-center">
                    <CheckIcon className="mr-3 text-green-500" />
                    <span>{t("subscriptions.vip.benefits.discount")}</span>
                  </li>
                  <li className="flex items-center">
                    <CheckIcon className="mr-3 text-green-500" />
                    <span>{t("subscriptions.vip.benefits.earlyAccess")}</span>
                  </li>
                  <li className="flex items-center">
                    <CheckIcon className="mr-3 text-green-500" />
                    <span>{t("subscriptions.vip.benefits.newsletter")}</span>
                  </li>
                  <li className="flex items-center">
                    <CheckIcon className="mr-3 text-green-500" />
                    <span>{t("subscriptions.vip.benefits.collections")}</span>
                  </li>
                  <li className="flex items-center">
                    <CheckIcon className="mr-3 text-green-500" />
                    <span>{t("subscriptions.vip.benefits.shipping")}</span>
                  </li>
                  <li className="flex items-center">
                    <CheckIcon className="mr-3 text-green-500" />
                    <span>{t("subscriptions.vip.benefits.support")}</span>
                  </li>
                </ul>
                <Button variant="secondary" className="w-full bg-gray-800 hover:bg-gray-900 text-white" onClick={() => window.location.href = "/auth"}>
                  {t("subscriptions.subscribeButton")}
                </Button>
              </div>
            </div>
